...
public class TopTenFragment extends BasedFragment implements IItemClick {
    View v;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.top_ten_frag,container,false);
        initView();
        ...
        youubePreviewAdapter = new YouubePreviewAdapter(v.getContext(),ids,TopTenFragment.this);
